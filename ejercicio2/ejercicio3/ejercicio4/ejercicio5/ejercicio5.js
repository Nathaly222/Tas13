'use strict'
//5. Cada libro del ejercicio anterior se encuentra ubicado en una estantería diferente dentro de una biblioteca, el índice del vector indica el numero de la estantería. Mostrar el numero de la estantería donde se encuentra el libro “You Don’t Know JS”
let programmingBooks = [
    ...
    alert(`${programmingBooks.find(element => element == titulo)? "Si" : "No"} se encuentra`);
    alert(`El libron "You Don't Know JS" se encuentra en la estanteria${programmingBooks.indexOf("You Don't Know JS")}`);